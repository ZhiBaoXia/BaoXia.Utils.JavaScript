...
export class ArrayUtilTest extends UnitTest.TestCase {
    ...
    ////////////////////////////////////////////////
    constructor() {
        super("ArrayUtil Test", (assert, assertFalse) => {
            let items = new Array();
            ...
            ArrayUtil.insertItemsTo(items, 1, [2, 3, 4]);
            {
            ...
            ArrayUtil.insertItemTo(items, 1, 1);
            {
            ...
            ArrayUtil.insertItemsTo(items, 3, [2, 3, 4]);
            {
            ...
            ArrayUtil.removeItemAt(items, 4);
            {
                assert(items.length == 7);
                assert(items[3] == 2);
                assert(items[4] == 4);
            }
            ArrayUtil.removeItemsInRangeFrom(items, 3, 2);
            {
                assert(items.length == 5);
                assert(items[3] == 3);
                assert(items[4] == 4);
