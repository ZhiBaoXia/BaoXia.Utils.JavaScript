...
export class StringUtilFormatTest extends TestCase
{
	constructor()
	{
		super("StringUtilFormatTest Test",
			(assert, assertFalse) =>
			{
				let stringFormated = StringUtil.format("%.2f", 2.99);
				{
					assert(stringFormated == "2.99");
				}

				stringFormated = StringUtil.format("%.2f", 5.98);
				{
					assert(stringFormated == "5.98");
				}


				stringFormated = StringUtil.format("0123Abc");
				{
